...
void run(const string& restaurantsFilePath,const string& districtsFilePath,const string& discountsFilePath,UserManager& userManager,DistrictManager& districtManager, RestaurantManager& restaurantManager) {
